...
public class DefaultVariant implements ConfigurationVariantInternal {
    ...
    public DefaultVariant(Describable parentDisplayName, String name,
        ...
        this.artifacts = publishArtifactSetFactory.create(getAsDescribable(), new DefaultDomainObjectSet<PublishArtifact>(PublishArtifact.class, collectionCallbackActionDecorator));
    }
