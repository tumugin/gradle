...
== For all users
 ...
 . If you are not already on version 4.10.2+, read the sections <<#changes_4.10,below>> for help upgrading your project to 4.10.X. We recommend upgrading to version 4.10.2 or higher first because 4.10.2 is the minimum version that includes the Deprecations tab in the build scan plugin.
