...
public interface PublishArtifactSet extends DomainObjectSet<PublishArtifact>, Buildable {
     ...
     */
    @Incubating
    DomainObjectProvider<ConfigurablePublishArtifact> register(Provider<? extends FileSystemLocation> artifactFile, Action<ConfigurablePublishArtifact> configuration);
